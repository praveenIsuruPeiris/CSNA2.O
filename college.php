...
$sql = "SELECT player_id, name, gender, position, school_id, telephone, street_Address, player_Rank, schoolType FROM player WHERE schoolType = 'college'";
...
if ($result->num_rows > 0) {
    ...
    echo "<h2 class='title error'> 0 results </h2>";
}
